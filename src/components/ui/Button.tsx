...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    destructive: 'bg-red-600 dark:bg-red-700 text-white hover:bg-red-700 dark:hover:bg-red-600 focus:ring-red-500 disabled:bg-red-300 dark:disabled:bg-red-900',
  };
