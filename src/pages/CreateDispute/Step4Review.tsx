...
export const Step4Review: React.FC<Step4ReviewProps> = ({ formData }) => {
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Review & Confirm</h2>
      ...
      <Card>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-lg font-semibold text-gray-900 dark:text-gray-50">{formData.title}</p>
          </div>

          <div>
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Type</h3>
            <p className="text-gray-900 dark:text-gray-50">{formData.type}</p>
          </div>

          <div>
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Description</h3>
            <p className="text-gray-900 dark:text-gray-50 whitespace-pre-wrap">{formData.description}</p>
          </div>

          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Parties & Stakes</h3>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Opponent Stake:</span>
                <span className="font-medium text-gray-900 dark:text-gray-50">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Validator</h3>
            <div className="space-y-2">
              <div className="flex justify-between">
